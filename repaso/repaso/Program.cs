    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            int[] arab =
            {
                ...
                80000, 90000,
                100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, 900000, 1000000, 2000000,3000000, 3999999
            };

            string[] rim =
            {
                "I", "IV", "V", "IX", "X", "XL", "L", "XC", "C", "CD", "D", "CM", "M", "MCD", "MD", "MCM", "MM", "MMCD",
                "MMD", "MMCM", "MMM", "MMMCD", "MMMD", "MMMCM", "I'V'", "V'", "V'I'", "V'II", "V'III", "I'X'", "X'", "X'X'",
                "X'X'X'", "X'L'", "L'", "L'X'", "LX'X'", "LX'X'X'", "C'X'", "C'", "C'C'", "C'C'C'", "C'D'", "D'", "D'C'", "D'C'C'",
                "D'C'C'C'",
